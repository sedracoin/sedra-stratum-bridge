...
Go to the latest release ([v1.1](https://github.com/sedracoin/sedra-stratum-bridge/releases/tag/v1.0.0) at the time of writing) and download the source code. Download the zip archive for windows, tar.gz for everything else.
...
- sd_bridge is running on port :5555
